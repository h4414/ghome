...
public class Actionneur {
    ...
    private static final String payload3 = "50";
   ...
   private static final String last0 = "0";
    ...
    public static String sendTrame(String numPrise){
        ...
        String trame =sync+hseqLength+org+payload3+payload2+payload1+payload0+id1+id0+last1+last0+numPrise+"30"+chkSum.substring(1);
        return trame;
    }
}
